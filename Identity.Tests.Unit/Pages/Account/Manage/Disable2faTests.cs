...
public class Disable2faTests
{
    ...
    public async Task OnGet_UserIsNull_ReturnsNotFoundWithUserIdInMessage()
    {
        ...
        var model = new Disable2fa(userManagerMock.Object)
        {
    ...
    public async Task OnGet_TwoFactorNotEnabled_ThrowsInvalidOperationException()
    {
        ...
        Assert.Equal(Disable2fa.TwoFactorNotEnabledMessage, ex.Message);
    }
    ...
    public async Task OnPostAsync_DisableFails_ThrowsInvalidOperationException()
    {
        ...
        // Assert
        var ex = Assert.IsType<InvalidOperationException>(exception);
        Assert.Equal(Disable2fa.DisableFailedMessage, ex.Message);
    }
    ...
    public async Task OnPostAsync_Succeeds_RedirectsAndSetsStatusMessage()
    {
        ...
        Assert.Equal(Disable2fa.TwoFactorDisabledMessage, model.StatusMessage);
    }

    private static Disable2fa CreateModelWithTwoFactorState(bool twoFactorEnabled)
    {
        var userManagerMock = MockHelpers.MockUserManager();
        ...
        return new Disable2fa(userManagerMock.Object)
        {
            PageContext = new PageContext
            {
                HttpContext = new DefaultHttpContext
