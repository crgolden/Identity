...
public class ForgotPasswordTests
{
    ...
    public async Task OnPostAsync_ModelStateInvalid_ReturnsPage()
    {
        ...
        var model = new ForgotPassword(userManagerMock.Object, factory, TestValues.NewAccountEmailSettings());
        ...
        model.Input = new AccountEmailPageBase.InputModel { Email = Generated.NewEmailAddress() };
    ...
    public async Task OnPostAsync_UnknownEmail_RedirectsToConfirmationWithoutSendingEmail()
    {
        ...
        model.PageContext = new PageContext { HttpContext = new DefaultHttpContext() };
        model.Input = new AccountEmailPageBase.InputModel { Email = unknownEmail };
    ...
    {
        // Arrange
        var unconfirmedEmail = Generated.NewEmailAddress();
        var userManagerMock = MockHelpers.MockUserManager();
        ...
        model.PageContext = new PageContext { HttpContext = new DefaultHttpContext() };
        model.Input = new AccountEmailPageBase.InputModel { Email = unconfirmedEmail };
