...
{
    private static readonly string Origin = Generated.NewOrigin();
    ...
    {
        // Arrange
        var client = new Client { Id = ExistingEntityId, ClientId = Generated.NewClientIdentifier(), AllowedCorsOrigins = [new ClientCorsOrigin { Id = ExistingEntityId, Origin = Origin, ClientId = ExistingEntityId }] };
