...
{
    private static readonly string PostLogoutUri = Generated.NewCallbackAddress();
    ...
    {
        // Arrange
        var client = new Client { Id = ExistingEntityId, ClientId = Generated.NewClientIdentifier(), PostLogoutRedirectUris = [new ClientPostLogoutRedirectUri { Id = ExistingEntityId, PostLogoutRedirectUri = PostLogoutUri, ClientId = ExistingEntityId }] };
