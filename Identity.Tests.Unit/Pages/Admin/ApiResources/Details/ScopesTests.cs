...
{
    private static readonly string ScopeName = Generated.NewApiScopeName();
    ...
    {
        // Arrange
        var resource = new ApiResource { Id = ExistingEntityId, Name = Generated.NewApiResourceName(), Scopes = [new ApiResourceScope { Id = ExistingEntityId, Scope = ScopeName }] };
