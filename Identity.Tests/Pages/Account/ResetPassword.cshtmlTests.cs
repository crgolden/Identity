...
namespace Identity.Tests.Pages.Account
{
    ...
    public class ResetPasswordModelTests
    {
        ...
        public void ResetPasswordModel_ValidUserManager_ConstructsSuccessfully()
        {
            ...
            var storeMock = new Moq.Mock<Microsoft.AspNetCore.Identity.IUserStore<IdentityUser<Guid>>>();
            var options = Microsoft.Extensions.Options.Options.Create(new Microsoft.AspNetCore.Identity.IdentityOptions());
            var passwordHasherMock = new Moq.Mock<Microsoft.AspNetCore.Identity.IPasswordHasher<IdentityUser<Guid>>>();
            var userValidators = new System.Collections.Generic.List<Microsoft.AspNetCore.Identity.IUserValidator<IdentityUser<Guid>>>();
            var passwordValidators = new System.Collections.Generic.List<Microsoft.AspNetCore.Identity.IPasswordValidator<IdentityUser<Guid>>>();
            var lookupNormalizerMock = new Moq.Mock<Microsoft.AspNetCore.Identity.ILookupNormalizer>();
            var errors = new Microsoft.AspNetCore.Identity.IdentityErrorDescriber();
            var services = new Moq.Mock<System.IServiceProvider>();
            var logger = new Moq.Mock<Microsoft.Extensions.Logging.ILogger<Microsoft.AspNetCore.Identity.UserManager<IdentityUser<Guid>>>>();

            var userManager = new Microsoft.AspNetCore.Identity.UserManager<IdentityUser<Guid>>(
                storeMock.Object,
                options,
