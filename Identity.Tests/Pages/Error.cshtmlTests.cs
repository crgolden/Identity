...
namespace Identity.Tests.Pages
{
    public class ErrorModelTests
    {
        ...
        {
            // null => IsNullOrEmpty(null) == true => ShowRequestId == false
            yield return new object?[] { null, false };

            // empty string => IsNullOrEmpty("") == true => ShowRequestId == false
            yield return new object?[] { string.Empty, false };

            // whitespace-only string => IsNullOrEmpty(" ") == false => ShowRequestId == true
            yield return new object?[] { " ", true };
            ...
            // newline characters => not empty => true
